...
- **FR-010**: Version 1 settings MUST contain automatic timezone mode, the searchable timezone selector, standard-time visibility, decimal separator selection, and Always On mode.
